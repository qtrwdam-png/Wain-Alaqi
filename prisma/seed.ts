...
const CATEGORIES: { name: string; slug: string; description: string; icon: string; sortOrder: number }[] = [
  ...
  // --- 50 قطاعاً إضافياً ---
  { name: "الساعات والإكسسوارات", slug: "watches-accessories", description: "ساعات وإكسسوارات رجالية ونسائية", icon: "⌚", sortOrder: 11 },
  { name: "العطور والبخور", slug: "perfumes-incense", description: "عطور وبخور ومباخر", icon: "🧴", sortOrder: 12 },
  { name: "الذهب والمجوهرات", slug: "jewelry", description: "ذهب ومجوهرات وفضيات", icon: "💍", sortOrder: 13 },
  { name: "الكتب والقرطاسية", slug: "books-stationery", description: "كتب وقرطاسية وأدوات مكتبية", icon: "📚", sortOrder: 14 },
  { name: "الألعاب والترفيه", slug: "toys-games", description: "ألعاب أطفال وترفيه عائلي", icon: "🎮", sortOrder: 15 },
  { name: "الرياضة واللياقة", slug: "sports-fitness", description: "مستلزمات رياضية وأدوات لياقة", icon: "⚽", sortOrder: 16 },
  { name: "الحاسبات والبرمجيات", slug: "computers-software", description: "حواسيب وبرامج وإكسسوارات", icon: "💻", sortOrder: 17 },
  { name: "الكاميرات والتصوير", slug: "cameras-photography", description: "كاميرات وعدسات وملحقات تصوير", icon: "📷", sortOrder: 18 },
  { name: "الآلات الموسيقية", slug: "musical-instruments", description: "آلات موسيقية وملحقاتها", icon: "🎸", sortOrder: 19 },
  { name: "الحرف اليدوية", slug: "handicrafts", description: "منتجات حرفية يدوية الصنع", icon: "🎨", sortOrder: 20 },
  { name: "المستلزمات الزراعية", slug: "agricultural-supplies", description: "بذور وأسمدة وأدوات زراعية", icon: "🌱", sortOrder: 21 },
  { name: "مستلزمات الحيوانات الأليفة", slug: "pet-supplies", description: "أغذية وملحقات الحيوانات الأليفة", icon: "🐾", sortOrder: 22 },
  { name: "النباتات والحدائق", slug: "gardening-plants", description: "نباتات وأحواض وأدوات حدائق", icon: "🪴", sortOrder: 23 },
  { name: "التنظيف والمنظفات", slug: "cleaning-supplies", description: "منظفات وأدوات تنظيف", icon: "🧹", sortOrder: 24 },
  { name: "مستحضرات التجميل", slug: "cosmetics", description: "مكياج وعناية بالجمال", icon: "💄", sortOrder: 25 },
  { name: "العناية بالشعر", slug: "hair-care", description: "منتجات صبغة وعناية بالشعر", icon: "💇", sortOrder: 26 },
  { name: "العناية بالبشرة", slug: "skincare", description: "كريمات ومرطبات للعناية بالبشرة", icon: "🧖", sortOrder: 27 },
  { name: "السفر والسياحة", slug: "travel-tourism", description: "مكاتب سفر وحجوزات وخدمات سياحية", icon: "✈️", sortOrder: 28 },
  { name: "الاتصالات والإنترنت", slug: "telecommunications", description: "خدمات اتصالات وإنترنت وشحن رصيد", icon: "📡", sortOrder: 29 },
  { name: "الطباعة والنشر", slug: "printing-publishing", description: "طباعة ومستلزمات مكتبية ودعائية", icon: "🖨️", sortOrder: 30 },
  { name: "الحماية والأمان", slug: "security-safety", description: "كاميرات مراقبة وأنظمة أمان", icon: "🔒", sortOrder: 31 },
  { name: "التكييف والتبريد", slug: "air-conditioning", description: "مكيفات وثلاجات وصيانة تبريد", icon: "❄️", sortOrder: 32 },
  { name: "السباكة", slug: "plumbing", description: "أدوات سباكة وصيانة مواسير", icon: "🔧", sortOrder: 33 },
  { name: "النجارة", slug: "carpentry", description: "أعمال نجارة وأثاث خشبي", icon: "🪚", sortOrder: 34 },
  { name: "الحدادة واللحام", slug: "welding-blacksmith", description: "أعمال حدادة ولحام معدني", icon: "🔨", sortOrder: 35 },
  { name: "الديكور والتصميم", slug: "decor-design", description: "ديكور داخلي وتصميم مساحات", icon: "🎭", sortOrder: 36 },
  { name: "المناسبات والأفراح", slug: "events-weddings", description: "تنظيم أفراح وقاعات ومناسبات", icon: "💐", sortOrder: 37 },
  { name: "تجهيزات المطاعم", slug: "restaurant-equipment", description: "معدات وأدوات مطاعم ومقاهي", icon: "🍳", sortOrder: 38 },
  { name: "المعدات الصناعية", slug: "industrial-equipment", description: "معدات وآلات صناعية", icon: "⚙️", sortOrder: 39 },
  { name: "الشحن والنقل", slug: "shipping-transport", description: "شحن ونقل وتوصيل بضائع", icon: "🚚", sortOrder: 40 },
  { name: "الدعاية والإعلان", slug: "advertising-marketing", description: "خدمات إعلانية وتسويق", icon: "📣", sortOrder: 41 },
  { name: "الصيرفة والصرافة", slug: "exchange-finance", description: "صرافة وخدمات مالية", icon: "💱", sortOrder: 42 },
  { name: "العقارات والإيجار", slug: "real-estate", description: "بيع وإيجار عقارات وأراضٍ", icon: "🏡", sortOrder: 43 },
  { name: "المكتبات القانونية", slug: "legal-services", description: "خدمات قانونية واستشارات", icon: "⚖️", sortOrder: 44 },
  { name: "التعليم والتدريب", slug: "education-training", description: "مراكز تعليم وتدريب ودراسة", icon: "🎓", sortOrder: 45 },
  { name: "الصحة والتغذية", slug: "health-nutrition", description: "مكملات غذائية واستشارات تغذية", icon: "🥗", sortOrder: 46 },
  { name: "الحلاقة والتجميل الرجالي", slug: "barber-grooming", description: "صالونات حلاقة وتجميل رجالي", icon: "💈", sortOrder: 47 },
  { name: "صالونات التجميل", slug: "beauty-salons", description: "صالونات تجميل وعناية نسائية", icon: "💅", sortOrder: 48 },
  { name: "المعدات الطبية", slug: "medical-equipment", description: "أجهزة ومستلزمات طبية", icon: "🩺", sortOrder: 49 },
  { name: "الطاقة الشمسية", slug: "solar-energy", description: "أنظمة طاقة شمسية وألواح", icon: "☀️", sortOrder: 50 },
  { name: "الهدايا والتغليف", slug: "gifts-wrapping", description: "هدايا وتغليف وتوزيعات", icon: "🎁", sortOrder: 51 },
  { name: "الصناعات الغذائية", slug: "food-industry", description: "منتجات غذائية محلية وتعليب", icon: "🥫", sortOrder: 52 },
  { name: "الإعلانات المبوبة", slug: "classifieds", description: "إعلانات بيع وشراء عامة", icon: "📋", sortOrder: 53 },
  { name: "الخدمات الحكومية", slug: "government-services", description: "خدمات حكومية واستخراج أوراق", icon: "🏛️", sortOrder: 54 },
  { name: "النقل المدرسي", slug: "school-transport", description: "نقل طلاب وخدمات مدرسية", icon: "🚌", sortOrder: 55 },
  { name: "مستلزمات الأطفال", slug: "baby-supplies", description: "ملابس وأغذية ومستلزمات أطفال", icon: "🍼", sortOrder: 56 },
  { name: "الورود والزهور", slug: "flowers", description: "باقات زهور وتنسيق ورود", icon: "🌹", sortOrder: 57 },
  { name: "التبريد العميق", slug: "cold-storage", description: "تبريد وتخزين وحفظ الأغذية", icon: "🧊", sortOrder: 58 },
  { name: "المياه والعبوات", slug: "water-bottles", description: "مياه شرب وعبوات وتوزيع", icon: "💧", sortOrder: 59 },
  { name: "الطوابع والعملات", slug: "stamps-coins", description: "طوابع وعملات تذكارية", icon: "🪙", sortOrder: 60 },
];
